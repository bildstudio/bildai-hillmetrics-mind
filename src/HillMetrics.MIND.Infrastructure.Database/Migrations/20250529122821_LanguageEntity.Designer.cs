...
namespace HillMetrics.MIND.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250529122821_LanguageEntity")]
            ...
            modelBuilder.Entity("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.Clients.ClientFluxRuleEntity", b =>
                {
                    ...
                    b.HasIndex("PeerGroupId")
                        .HasDatabaseName("ix_clients_flux_rules_peer_group_id");

                    b.ToTable("clients_flux_rules", (string)null);
                });

            modelBuilder.Entity("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.LanguageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DtInsert = new DateTime(2025, 5, 29, 0, 0, 0, 0, DateTimeKind.Utc),
                            DtUpdate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            Name = "English",
                            TwoLetterCode = "en"
                        },
            ...
            modelBuilder.Entity("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.Users.UserAccountEntity", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_user_accounts_client_id");
            ...
            modelBuilder.Entity("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.Clients.ClientFluxRuleEntity", b =>
                {
                    ...
                    b.HasOne("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.PeerGroups.PeerGroupEntity", "PeerGroup")
                        .WithMany("ClientFluxRules")
                        .HasForeignKey("PeerGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_clients_flux_rules_peer_groups_peer_group_id");
            ...
            modelBuilder.Entity("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.Users.UserAccountEntity", b =>
                {
                    b.HasOne("HillMetrics.MIND.Infrastructure.Contracts.Database.Entity.Clients.ClientEntity", "Client")
                        .WithMany("Users")
                        .HasForeignKey("ClientId")
                        .HasConstraintName("fk_user_accounts_clients_client_id");
